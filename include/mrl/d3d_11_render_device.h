#ifndef MRL_D3D_11_RENDER_DEVICE_H
#define MRL_D3D_11_RENDER_DEVICE_H
#ifdef __cplusplus
extern "C" {
#endif 
...
#include <mrl/render_device.h>
	...
	///		The typename of this render device is 'd3d_11'.
	/// </summary>
	...
	MRL_API void mrl_terminate_d3d_11_render_device(mrl_render_device_t* rd);
